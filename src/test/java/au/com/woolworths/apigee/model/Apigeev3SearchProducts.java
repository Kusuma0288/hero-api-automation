...
public class Apigeev3SearchProducts {
        ...
        public void setFooter(Object footer){this.footer = footer;}
        ...
        public void setStock(Object stock){this.stock = stock;}

        public void setHasBeenBoughtBefore(Boolean hasBeenBoughtBefore) {this.hasBeenBoughtBefore = hasBeenBoughtBefore;}
